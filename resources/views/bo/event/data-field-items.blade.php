...
margin-left: auto; margin-right:auto;">
    <div class="card-body">
      ...
      <div class="form-group">
        <label>link</label>
          @if ($fieldEnabled == true)
            <input type="text" name="link" class="form-control" placeholder="" value="{{ $viewModel->data->link }}">
          @else
            <input disabled type="text" name="link" class="form-control" placeholder="" value="{{ $viewModel->data->link }}">
          @endif
