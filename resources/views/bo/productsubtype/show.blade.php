...
@section('content_title', 'Product Sub Type Info')
...
<!-- button edit -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('productsubtype.edit', ['productsubtype' => $viewModel->data->id]) }}">
...
<li class="nav-item">
    ...
    <form id="frmData" role="form" id="frmData" method="POST" action="{{ route('productsubtype.destroy', ['productsubtype' => $viewModel->data->id]) }}">
        @csrf
        @method('DELETE')
    </form>
</li>
