...
@section('content_title', 'Mater Category Info')
...
<!-- button edit -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('mastercategory.edit', ['mastercategory' => $viewModel->data->id]) }}">
...
<li class="nav-item">
    ...
    <form id="frmData" role="form" id="frmData" method="POST" action="{{ route('mastercategory.destroy', ['mastercategory' => $viewModel->data->id]) }}">
        @csrf
        @method('DELETE')
    </form>
</li>
